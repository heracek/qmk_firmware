...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = EXPAND_LAYOUT( \
      ...
      _________________QWERTY_L4_________________,  KC_LBRC, KC_RBRC,   _________________QWERTY_R4_________________, \
      _________________QWERTY_L5_________________,  KC_SPC,  KC_SPC,    _________________QWERTY_R5_________________ \
  ),
  ...
  [_ADJUST] = EXPAND_LAYOUT( \
      ...
      _________________ADJUST_L4_________________,  RGB_TOG,  RGBRST,   _________________ADJUST_R4_________________, \
      _________________ADJUST_L5_________________,  RGB_RMOD, RGB_MOD,  _________________ADJUST_R5_________________ \
  ),
};
