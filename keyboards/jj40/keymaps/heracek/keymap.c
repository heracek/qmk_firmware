...
[_RAISE] = LAYOUT_ortho_4x12( \
  ...
  KC_GESC, KC_4,    KC_5,    KC_6,    KC_PPLS, KC_PMNS, KC_PAST, KC_PSLS, KC_PEQL, KC_UNDS, KC_MINS, KC_ENT , \
  KC_LSFT, KC_7,    KC_8,    KC_9,    KC_0,    KC_LPRN, KC_RPRN, KC_PDOT, KC_COMM, KC_DOT,  KC_SLSH, KC_BSLS, \
